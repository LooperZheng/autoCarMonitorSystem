...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Camthread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 35, 9)
    ...
    "Camthread\0sig_GetOneFrame\0\0sig_err\0"
    "readFrame\0"
};
...
void Camthread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Camthread::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camthread::sig_GetOneFrame)) {
                *result = 0;
            }
        }
        {
            typedef void (Camthread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camthread::sig_err)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Camthread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Camthread.data,
      qt_meta_data_Camthread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Camthread.stringdata))
