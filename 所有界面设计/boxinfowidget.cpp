...
void BoxInfoWidget::on_pushButton_closeBox_clicked()
{
...
//    }
    ...
    for(int i =0; i<rec_2v_index.size();i++)
    {
        ...
        if(index ==0 )
            item->setPos(110*(-3)+3, 100*(-2)-7);
        if(index ==1 )
            item->setPos(110*(-3)+3, 100*(-0)-7);
        if(index ==2 )
            item->setPos(110*(-2)+3, 100*(-2)-7);
        if(index ==3 )
    ...
    for(int i =0; i<rec_4_index.size();i++)
    {
        ...
        if(index ==0 )
            item->setPos(110*(-3)+4, 100*(-2)-7);
        if(index ==1 )
            item->setPos(110*(-3)+4, 100*(0)-7);
        if(index ==2 )
            item->setPos(110*(-1)+4, 100*(-1)-7);
        if(index ==3 )
            item->setPos(110*(1)+4, 100*(-2)-7);
        if(index ==4 )
